...
function SubCategoryDropdown({ categoryId, value, onValueChange, company, error }: SubCategoryDropdownProps) {
  const subCategoriesHook = useSubCategories(categoryId, { company })
...
function ItemDescriptionDropdown({
  ...
  const itemDescriptionsHook = useItemDescriptions({ company, item_category: categoryId, sub_category: subCategoryId })
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFormData("lr_number", e.target.value)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {formData.vendor_supplier_name === "Other" && (
                    <div className="mt-2">
                      <div>
                        <Label htmlFor="custom_vendor_name">Custom Vendor Name</Label>
                        <Input
                ...
                <div>
                  ...
                  {formData.customer_party_name === "Other" && (
                    <div className="mt-2">
                      <div>
                        <Label htmlFor="custom_customer_name">Custom Customer Name</Label>
                        <Input
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFormData("purchase_by", e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFormData("approval_authority", e.target.value)}
                    placeholder="Manager ABC"
                  />
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFormData("grn_quantity", Number(e.target.value))}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFormData("received_quantity", Number(e.target.value))}
                    onWheel={(e) => e.currentTarget.blur()}
                  />
                </div>
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <SimpleDropdown
                        ...
                        onValueChange={(value) => {
                          // Update the article with new category and clear dependent fields
                          updateArticle(article.id, "item_category", value)
                        }}
                        placeholder="Select category..."
                        options={itemCategoriesHook.options}
                        loading={itemCategoriesHook.loading}
                        error={itemCategoriesHook.error}
                        className={errors[`article_${index}_category`] ? "border-red-500" : ""}
                      />
                    ...
                    <div>
                      ...
                      <SubCategoryDropdown
                        ...
                        onValueChange={(value) => {
                          // Update the article with new sub category and clear dependent fields
                          updateArticle(article.id, "sub_category", value)
                        }}
                        company={company}
                    ...
                    {/* Packaging Type */}
                    <div>
                      <Label htmlFor={`packaging_type_${article.id}`}>Packaging Type</Label>
                      <Input
                        id={`packaging_type_${article.id}`}
                        value={article.packaging_type}
                        onChange={(e) => updateArticle(article.id, "packaging_type", e.target.value)}
                        placeholder="Box - 10kg"
                      />
                    </div>
