...
function SubCategoryDropdown({ articleId, categoryId, value, onValueChange, company, error, disabled, materialType }: SubCategoryDropdownProps & { materialType?: string }) {
...
function ItemDescriptionDropdown({
  ...
  updateArticle,
  disabled,
}: ItemDescriptionDropdownProps & { materialType: string; disabled?: boolean }) {
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={formData.purchase_by} onValueChange={(value) => setFormData(prev => ({ ...prev, purchase_by: value }))}>
                    ...
                    <div className="mt-2">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setFormData(prev => ({ ...prev, custom_purchase_by: e.target.value }))}
