...
function SubCategoryDropdown({ articleId, categoryId, value, onValueChange, company, error }: SubCategoryDropdownProps) {
...
export default function EditInwardPage() {
  ...
  const itemCategoriesHook = useItemCategories({ company: company as Company })
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, lr_number: e.target.value }))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, grn_quantity: Number(e.target.value) }))}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, received_quantity: Number(e.target.value) }))}
                    onWheel={(e) => e.currentTarget.blur()}
                  />
                </div>
                <div>
