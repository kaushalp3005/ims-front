    ...
    <div className="container mx-auto p-3 sm:p-4 lg:p-6">
        <Card className="max-w-sm sm:max-w-2xl lg:max-w-4xl mx-auto">
          <CardHeader className="text-center p-4 sm:p-6">
            ...
            <CardTitle className="text-xl sm:text-2xl lg:text-3xl">RTV/Rejection System</CardTitle>
            <CardDescription className="text-sm sm:text-base lg:text-lg">Manage Return to Vendor and rejection processes</CardDescription>
          ...
          <CardContent className="space-y-4 sm:space-y-6 p-4 sm:p-6">
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">
                This module is currently being developed. It will include Return to Vendor (RTV) 
                processes, rejection management, and vendor return workflows.
              </p>
            </div>
            ...
            <div className="bg-muted/50 p-3 sm:p-4 rounded-lg">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">
                The RTV/Rejection module is being built to provide Return to Vendor processes 
                and rejection management capabilities.
              </p>
            </div>
